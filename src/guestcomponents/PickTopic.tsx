...
import { Typography, CircularProgress, Paper, Box, IconButton, Pagination, Tooltip, Chip } from "@mui/material";
...
const PickTopic: React.FC = () => {
  const { setCurrentPage, setSelectedTopicId } = useGuestPageStore();
          ...
          >
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 1 }}>
              ...
              <Tooltip title={copiedId === topic._id ? "Copied!" : "Copy ID"}>
                <Chip
                  label={topic._id}
                  onClick={(e) => handleCopyId(topic._id, e)}
